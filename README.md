...
[![test](https://github.com/sadpenguinn/pgvet/actions/workflows/test.yaml/badge.svg)](https://github.com/sadpenguinn/pgvet/actions/workflows/test.yaml)
...
[![go-report](https://goreportcard.com/badge/github.com/sadpenguinn/pgvet)](https://goreportcard.com/report/github.com/sadpenguinn/pgvet)
...
```sql
DROP TABLE legacy_users; -- nolint:drop-table
```

To suppress all rules on a line:

```sql
DROP TABLE legacy_users; -- nolint
```
